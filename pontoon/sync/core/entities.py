...
def update_resources(
    ...
    obs_count = Entity.objects.bulk_update(obsolete_entities, ["obsolete", "date_obsoleted"])
...
def entity_from_source(resource: Resource, now: datetime, idx: int, tx: SilmeEntity) -> Entity:
